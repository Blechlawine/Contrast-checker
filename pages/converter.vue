<template>
  <div id="app">
    ...
    <ColorPickerBig :hueIn="this.hue" :satIn="this.saturation" :valIn="this.value"
                    v-on:colorChanged="this.updateColor"/>
    <Slider :min="0" :max="10" :background="this.background" :valueIn="this.factor" :handleBackground="this.background"
            v-on:onSlide="this.sliidee"/>
  ...
  data() {
    return {
      tabs: [
        ...
        {id: 2, title: "Converter", link: "/converter", active: true}
      ],
      hue: 100,
      saturation: 100,
      value: 50,
